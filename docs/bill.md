...
Request request = new ListBills()
        .page(5041)                               // ページ番号
        .perPage(8822)                            // 1ページの表示数
        .billId("5McyOYY")                        // 支払いQRコードのID
        .privateMoneyId("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx") // マネーID
        .organizationCode("A0-RpI1VV--b-")        // 組織コード
        .description("test bill")                 // 取引説明文
        .createdFrom("2022-10-10T19:55:23.000000+09:00") // 作成日時(起点)
        .createdTo("2020-10-06T12:08:26.000000+09:00") // 作成日時(終点)
        .shopName("bill test shop1")              // 店舗名
        .shopId("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx") // 店舗ID
        .lowerLimitAmount(5945)                   // 金額の範囲によるフィルタ(下限)
        .upperLimitAmount(6546)                   // 金額の範囲によるフィルタ(上限)
