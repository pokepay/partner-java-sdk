...
Request request = new ListBills()
        .page(4453)                               // ページ番号
        .perPage(5033)                            // 1ページの表示数
        .billId("sFhn")                           // 支払いQRコードのID
        .privateMoneyId("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx") // マネーID
        .organizationCode("Aj0A6")                // 組織コード
        .description("test bill")                 // 取引説明文
        .createdFrom("2021-09-29T09:58:14.000000Z") // 作成日時(起点)
        .createdTo("2022-04-17T10:31:09.000000Z") // 作成日時(終点)
        .shopName("bill test shop1")              // 店舗名
        .shopId("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx") // 店舗ID
        .lowerLimitAmount(8508)                   // 金額の範囲によるフィルタ(下限)
        .upperLimitAmount(5113)                   // 金額の範囲によるフィルタ(上限)
