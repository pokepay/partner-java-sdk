...
Request request = new BulkCreateTransaction(
    "ITzOAAOQJg9Oh2auryJ2P3ta",                   // name: 一括取引タスク名
    "v",                                          // content: 取引する情報のCSV
    "VPQPmTEjzklDTch40KKKiKcUgCcD7fX9bf4L"        // requestId: リクエストID
)
        .description("Cyf0eVYP4aqdWYvOrZh0NTnjUJCf") // 一括取引の説明
