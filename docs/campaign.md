...
Request request = new CreateCampaign(
    ...
    "external-transaction"                        // event: イベント種別
        ...
        .applicableDaysOfWeek(new Integer[]{1,4}) // キャンペーンを適用する曜日 (複数指定)
        .applicableTimeRanges(new Object[]{items6,items7}) // キャンペーンを適用する時間帯 (複数指定)
...
Request request = new UpdateCampaign(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // campaignId: キャンペーンID
        ...
        .applicableDaysOfWeek(new Integer[]{5,1}) // キャンペーンを適用する曜日 (複数指定)
