...
Request request = new ListAccountBalances(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // accountId: ウォレットID
        ...
        .page(3336)                               // ページ番号
        .perPage(3608)                            // 1ページ分の取引数
        .expiresAtFrom("2024-05-31T17:53:22.000000Z") // 有効期限の期間によるフィルター(開始時点)
        .expiresAtTo("2020-05-25T03:33:29.000000Z") // 有効期限の期間によるフィルター(終了時点)
...
Request request = new ListAccountExpiredBalances(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // accountId: ウォレットID
        ...
        .page(109)                                // ページ番号
        .perPage(9807)                            // 1ページ分の取引数
        .expiresAtFrom("2022-08-16T16:09:33.000000Z") // 有効期限の期間によるフィルター(開始時点)
        .expiresAtTo("2022-08-11T11:18:34.000000Z") // 有効期限の期間によるフィルター(終了時点)
        .direction("asc");                        // 有効期限によるソート順序
...
Request request = new UpdateCustomerAccount(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // accountId: ウォレットID
        ...
        .status("suspended")                      // ウォレット状態
        .accountName("pOFZAAuAkdYYYV8q02r77ePIgPu4dPH7ImSF7bIQ97lNoNEqqi11P4GN23Eb6NlDd7BTwpYu4Valw5xiIJ7Q1Cipp2CPMRifbrHbdPk0z0U5np6zSSSsJChBCfGVrTTzFEA3cEkuniAENmbJtM74yoK3yNaovdjb7urlPondGWEfVzKM") // アカウント名
        .externalId("w")                          // 外部ID
...
Request request = new GetCustomerAccounts(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // privateMoneyId: マネーID
        ...
        .page(6209)                               // ページ番号
        .perPage(617)                             // 1ページ分のウォレット数
        .createdAtFrom("2020-08-18T23:12:40.000000Z") // ウォレット作成日によるフィルター(開始時点)
        .createdAtTo("2020-01-21T15:44:21.000000Z") // ウォレット作成日によるフィルター(終了時点)
        .setSuspended(false)                      // ウォレットが凍結状態かどうかでフィルターする
        .status("pre-closed")                     // ウォレット状態
        .externalId("ATPnnGfbSAjt8y1LpRX9w3aEMSDM7H6DKpMVCMs6AqP") // 外部ID
...
Request request = new CreateCustomerAccount(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // privateMoneyId: マネーID
        ...
        .externalId("errdPPsgFTBp21GVpuNthlN8cTNxtClPPAh3ydu"); // 外部ID
...
Request request = new GetShopAccounts(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // privateMoneyId: マネーID
        ...
        .page(8201)                               // ページ番号
        .perPage(4004)                            // 1ページ分のウォレット数
        .createdAtFrom("2020-06-04T04:22:02.000000Z") // ウォレット作成日によるフィルター(開始時点)
        .createdAtTo("2023-02-26T22:06:45.000000Z") // ウォレット作成日によるフィルター(終了時点)
        .setSuspended(false);                     // ウォレットが凍結状態かどうかでフィルターする
