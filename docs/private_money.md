...
Request request = new GetPrivateMoneyOrganizationSummaries(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // privateMoneyId: マネーID
        ...
        .from("2021-11-06T00:17:22.000000+09:00") // 開始日時(toと同時に指定する必要有)
        .to("2023-05-26T00:09:06.000000+09:00")   // 終了日時(fromと同時に指定する必要有)
        .page(1)                                  // ページ番号
...
Request request = new GetPrivateMoneySummary(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // privateMoneyId: マネーID
        ...
        .from("2020-02-16T06:59:46.000000+09:00") // 開始日時
        .to("2024-08-08T20:31:22.000000+09:00");  // 終了日時
