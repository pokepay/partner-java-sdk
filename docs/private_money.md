...
Request request = new GetPrivateMoneyOrganizationSummaries(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // privateMoneyId: マネーID
        ...
        .from("2022-01-29T21:20:04.000000+09:00") // 開始日時(toと同時に指定する必要有)
        .to("2021-10-08T00:16:01.000000+09:00")   // 終了日時(fromと同時に指定する必要有)
        .page(1)                                  // ページ番号
...
Request request = new GetPrivateMoneySummary(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // privateMoneyId: マネーID
        ...
        .from("2024-01-23T12:10:46.000000+09:00") // 開始日時
        .to("2021-04-11T03:22:08.000000+09:00");  // 終了日時
