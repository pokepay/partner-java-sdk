...
Request request = new ListShops()
        ...
        .name("oxスーパー三田店")                        // 店舗名
        .postalCode("7035233")                    // 店舗の郵便番号
        .address("東京都港区芝...")                     // 店舗の住所
        .tel("0218972")                           // 店舗の電話番号
        .email("WXTyyeQyig@nPlT.com")             // 店舗のメールアドレス
        .externalId("5ZHpgoJFWjugtCHYXOd05sYz53") // 店舗の外部ID
...
Request request = new CreateShop(
    "oxスーパー三田店"                                   // shopName: 店舗名
        ...
        .shopPostalCode("4922797")                // 店舗の郵便番号
        .shopAddress("東京都港区芝...")                 // 店舗の住所
        .shopTel("041-553701")                    // 店舗の電話番号
        .shopEmail("iQG67QDvkH@KJGG.com")         // 店舗のメールアドレス
        .shopExternalId("064A8gYbU6HYrc")         // 店舗の外部ID
...
Request request = new CreateShopV2(
    "oxスーパー三田店"                                   // name: 店舗名
        ...
        .postalCode("8712956")                    // 店舗の郵便番号
        .address("東京都港区芝...")                     // 店舗の住所
        .tel("035670-3227")                       // 店舗の電話番号
        .email("ZovhsgS2MR@Dbqd.com")             // 店舗のメールアドレス
        .externalId("mmOpdtXK9qXcNjoycLpJ7c9FyCJSPr") // 店舗の外部ID
        .organizationCode("ox-supermarket")       // 組織コード
...
Request request = new UpdateShop(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // shopId: 店舗ユーザーID
        ...
        .name("oxスーパー三田店")                        // 店舗名
        .postalCode("3602784")                    // 店舗の郵便番号
        .address("東京都港区芝...")                     // 店舗の住所
        .tel("05-745481")                         // 店舗の電話番号
        .email("WqB9yeEoNP@HRmB.com")             // 店舗のメールアドレス
        .externalId("ItMbDjso")                   // 店舗の外部ID
        .privateMoneyIds(new String[]{"xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx","xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx","xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"}) // 店舗で有効にするマネーIDの配列
