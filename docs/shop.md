...
Request request = new ListShops()
        ...
        .name("oxスーパー三田店")                        // 店舗名
        .postalCode("1938265")                    // 店舗の郵便番号
        .address("東京都港区芝...")                     // 店舗の住所
        .tel("073649-2235")                       // 店舗の電話番号
        .email("9DAcW49eKh@vXSD.com")             // 店舗のメールアドレス
        .externalId("tNZFfG9g9ktH")               // 店舗の外部ID
...
Request request = new CreateShop(
    "oxスーパー三田店"                                   // shopName: 店舗名
        ...
        .shopPostalCode("8232711")                // 店舗の郵便番号
        .shopAddress("東京都港区芝...")                 // 店舗の住所
        .shopTel("005-5538-6311")                 // 店舗の電話番号
        .shopEmail("05qODRAtSR@6p9A.com")         // 店舗のメールアドレス
        .shopExternalId("RtC8")                   // 店舗の外部ID
...
Request request = new CreateShopV2(
    "oxスーパー三田店"                                   // name: 店舗名
        ...
        .postalCode("314-1945")                   // 店舗の郵便番号
        .address("東京都港区芝...")                     // 店舗の住所
        .tel("07-39551323")                       // 店舗の電話番号
        .email("Dlapcu30uY@qm4K.com")             // 店舗のメールアドレス
        .externalId("JG9jd1xrLwoXVoBmdqdA")       // 店舗の外部ID
        .organizationCode("ox-supermarket")       // 組織コード
...
Request request = new UpdateShop(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // shopId: 店舗ユーザーID
        ...
        .name("oxスーパー三田店")                        // 店舗名
        .postalCode("7260916")                    // 店舗の郵便番号
        .address("東京都港区芝...")                     // 店舗の住所
        .tel("0865520756")                        // 店舗の電話番号
        .email("SeSgqBhx9p@gNJO.com")             // 店舗のメールアドレス
        .externalId("LUhW8ortjx3GHpokPEb61pRhEJZrKbYpOL") // 店舗の外部ID
        .privateMoneyIds(new String[]{"xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx","xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"}) // 店舗で有効にするマネーIDの配列
