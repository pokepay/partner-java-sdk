...
Request request = new GetCpmToken(
    "FofQJvooJsV6q3MQ6iDi4r"                      // cpmToken: CPMトークン
);
...
Request request = new ListTransactions()
        .from("2021-01-03T05:53:29.000000+09:00") // 開始日時
        .to("2020-09-03T12:15:23.000000+09:00")   // 終了日時
        .page(1)                                  // ページ番号
...
Request request = new CreateTransaction(
    ...
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"
        ...
        .moneyAmount(4384)
        .pointAmount(552)
        .pointExpiresAt("2023-12-22T03:33:28.000000+09:00") // ポイント有効期限
        .description("QF2KLrWZCSSwVktqev88e");
...
Request request = new ListTransactionsV2()
        ...
        .customerName("太郎")                       // エンドユーザー名
        .description("店頭QRコードによる支払い")             // 取引説明文
        .transactionId("B4CsS")                   // 取引ID
        .setModified(false)                       // キャンセルフラグ
        .types(new String[]{"topup","payment"})   // 取引種別 (複数指定可)、チャージ=topup、支払い=payment
        .from("2023-10-15T01:04:44.000000+09:00") // 開始日時
        .to("2021-07-15T02:32:04.000000+09:00")   // 終了日時
...
Request request = new CreateTopupTransaction(
    ...
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // privateMoneyId: マネーID
        ...
        .moneyAmount(7912)                        // マネー額
        .pointAmount(7894)                        // ポイント額
        .pointExpiresAt("2022-03-06T20:36:01.000000+09:00") // ポイント有効期限
...
Request request = new CreatePaymentTransaction(
    ...
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       // privateMoneyId: マネーID
    6978,                                         // amount: 支払い額
    new Object[]{items,items2}                    // products: 商品情報データ
)
...
Request request = new CreateCpmTransaction(
    "UqkFRYFTUd9G7Oa9gBlCBd",                     // cpmToken: CPMトークン
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",       // shopId: 店舗ID
    5970.0,                                       // amount: 取引金額
    new Object[]{items,items2,items3}             // products: 商品情報データ
)
...
Request request = new CreateExchangeTransaction(
    ...
    632
        ...
        .description("BF9znmb5TnETpk4XDt48i9eDHc1ViXNJBSPYleThOoSsC0tCbLzilyNqcNCmb")
        .requestId("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"); // リクエストID
...
Request request = new RefundTransaction(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // transactionId: 取引ID
        ...
        .returningPointExpiresAt("2023-01-16T07:31:30.000000+09:00"); // 返却ポイントの有効期限
