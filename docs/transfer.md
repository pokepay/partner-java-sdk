...
Request request = new GetAccountTransferSummary(
    "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"        // accountId: ウォレットID
        ...
        .from("2023-06-01T21:28:59.000000+09:00") // 集計期間の開始時刻
        .to("2023-01-28T03:33:19.000000+09:00")   // 集計期間の終了時刻
...
Request request = new ListTransfers()
        .from("2022-10-22T00:21:45.000000+09:00")
        .to("2021-05-25T12:18:53.000000+09:00")
        .page(8516)
        .perPage(5564)
        .shopId("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx")
        .shopName("6xEXlvoGW8IviOqd71Gnf1kYLSq6kdJ41uxPki9qWFs77GJzm0P3ZdljauBBEYAoBHebTHgjV324u7YBe0pvzFfaA7cQnOeBWtVY46wLZ8JYEjjG7RCwnvgoATSGgxfeooq7Vcm0G5CUQ8QZ8OnfSgrjauu97txKJCS8kILVsHe8r1E2NOIZC5cYh484sTQauHaezuo5bU8GjRsKCECDgstQdwlvfQNJEWZgVXeu6rqJ4gEVIUpKfPz9eb")
        .customerId("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx")
        .customerName("e9SfqjPsKJpomZGGJBL161aLRjeEGEuDRsxe4tlY0O7hAmZ8lZf1X3iI0Rt8TKWS5LgYNN88qePtwU0CUm9cSeeycXyRLv")
        .transactionId("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx")
        .privateMoneyId("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx")
        .setModified(false)
        .transactionTypes(new String[]{"transfer","expire","topup","cashback","payment","exchange"})
        .transferTypes(new String[]{"payment","expire","transfer","exchange","campaign","cashback"}) // 取引明細の種類でフィルターします。
...
Request request = new ListTransfersV2()
        ...
        .shopName("9d4Z8H5faLiDcBKr7jV2QnswdqVW7MmYD") // 店舗名
        .customerId("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx") // エンドユーザーID
        .customerName("2Cd1Cf1ivgDwauGnuMMGcirrdWDzAN5KI2usB1LYu2wHgDKY4Fn2oQxJejnaqOVkKmNKDadNDVQWhGVYLQjez7B5UI6cLBwx48Ht8UB8scttAag") // エンドユーザー名
        ...
        .transferTypes(new String[]{"payment","campaign","cashback"}) // 取引明細種別 (複数指定可)
        .description("店頭QRコードによる支払い")             // 取引詳細説明文
        .from("2021-06-22T21:22:52.000000+09:00") // 開始日時
        .to("2020-05-02T18:15:34.000000+09:00");  // 終了日時
