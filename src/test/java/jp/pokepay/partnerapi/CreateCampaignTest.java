    ...
    void test42() throws ConnectionError, ProcessingError {
        ...
        Request request = new CreateCampaign(
            ...
            "topup"
                ...
                .pointExpiresAt("2024-04-02T00:00:28.000000Z")
                .status("disabled")
                .description("63tcX")
                .bearPointShopId("8c619850-697f-42fa-8090-6c295aa5766d");
        try {
            PartnerAPITest.getClient().send(request);
        } catch (PartnerRequestError e) {
            if (e.getType().equals("invalid_parameters")) {
    ...
    void test43() throws ConnectionError, ProcessingError {
        ...
        Request request = new CreateCampaign(
            ...
            "topup"
                ...
                .blacklistedShopIds(new String[]{"dfe04909-6de1-4a6f-be1d-8c30b68c6ec5","a1f3c857-bcde-4a9f-ae52-b318b088971f","afb6f699-05d6-4c23-83ea-90ec63a90067"})
                .applicableAccountMetadata(applicable_account_metadata)
                .destPrivateMoneyId("332f1197-a5da-4c63-a69f-89787074a640")
                .maxTotalPointAmount(899)
                .maxPointAmount(2777)
                .existInEachProductGroups(true)
                .minimumNumberForCombinationPurchase(2927)
                .minimumNumberOfAmount(8450)
                .minimumNumberOfProducts(9042)
                .applicableTimeRanges(new Object[]{items,items2,items3,items4,items5,items6,items7})
                .applicableDaysOfWeek(new Integer[]{4,6,6,3,3,2,3,4,0})
                ...
                .subject("all")
                .setExclusive(true)
                .pointExpiresInDays(5955)
                .pointExpiresAt("2020-05-06T01:07:38.000000Z")
                .status("disabled")
                .description("N78kqzJ0Us2fGrJyLKsRHFPpRHSTTSFxnvRwj3")
                .bearPointShopId("a253b1a8-a1a9-4dac-8fe1-2003e71d9a33");
        try {
            PartnerAPITest.getClient().send(request);
        } catch (PartnerRequestError e) {
            if (e.getType().equals("invalid_parameters")) {
    ...
    void test44() throws ConnectionError, ProcessingError {
        ...
        Request request = new CreateCampaign(
            ...
            "topup"
                ...
                .blacklistedShopIds(new String[]{"1f13c61c-18aa-44f2-8407-3482d7ec2fa9","62a6ddfc-7eff-42ad-80c6-17d0ac41921b","4b9e3cb8-77d2-46a9-b4a5-99e217b8621d","76522a19-dc93-4e68-92cf-d5e4b0360ae1","f6068ec2-74a9-4a8c-b7c7-6ecc69927c00","38c486a1-e81b-498e-8bd6-add6115c538e"})
                .applicableTransactionMetadata(applicable_transaction_metadata)
                .applicableAccountMetadata(applicable_account_metadata)
                .destPrivateMoneyId("d7b011c8-c677-47f4-8e33-161afd2116c1")
                .maxTotalPointAmount(5959)
                .maxPointAmount(7047)
                .existInEachProductGroups(true)
                .minimumNumberForCombinationPurchase(4019)
                .minimumNumberOfAmount(4273)
                .minimumNumberOfProducts(3415)
                .applicableTimeRanges(new Object[]{items,items2})
                .applicableDaysOfWeek(new Integer[]{1,2,0,2})
                ...
                .subject("all")
                .setExclusive(false)
                .pointExpiresInDays(5000)
                .pointExpiresAt("2020-10-22T11:18:16.000000Z")
                .status("enabled")
                .description("YnMI0dEOIqOFLqn2ZuLk5GF2FUuyDVUpZnC5UYez0zM0cPoxe0DGq4e7wXOOVc8GIqj26qcMQ423OrAYOyd2")
                .bearPointShopId("ee6dc6b1-26a8-4995-bdcc-141c8befc116");
        try {
            PartnerAPITest.getClient().send(request);
        } catch (PartnerRequestError e) {
            if (e.getType().equals("invalid_parameters")) {
    ...
    void test45() throws ConnectionError, ProcessingError {
        ...
        Request request = new CreateCampaign(
            ...
            "topup"
                ...
                .blacklistedShopIds(new String[]{"bf27061c-56fc-49a9-a1a5-5a9c1f0e5d39"})
                .budgetCapsAmount(331285686)
                .applicableTransactionMetadata(applicable_transaction_metadata)
                .applicableAccountMetadata(applicable_account_metadata)
                .destPrivateMoneyId("df4fb7e5-88bc-4541-a147-ed34f014e24a")
                .maxTotalPointAmount(6438)
                .maxPointAmount(2648)
                .existInEachProductGroups(true)
                .minimumNumberForCombinationPurchase(3657)
                .minimumNumberOfAmount(6840)
                .minimumNumberOfProducts(2656)
                .applicableTimeRanges(new Object[]{items,items2,items3,items4,items5})
                .applicableDaysOfWeek(new Integer[]{0,0,6})
                ...
                .subject("all")
                .setExclusive(true)
                .pointExpiresInDays(2654)
                .pointExpiresAt("2023-08-19T10:13:59.000000Z")
                .status("enabled")
                .description("yc3XcFOYpAAHYYK9z7")
                .bearPointShopId("f8d8c53b-8685-40b3-8b75-3ef8ce761944");
        try {
            PartnerAPITest.getClient().send(request);
        } catch (PartnerRequestError e) {
            if (e.getType().equals("invalid_parameters")) {
